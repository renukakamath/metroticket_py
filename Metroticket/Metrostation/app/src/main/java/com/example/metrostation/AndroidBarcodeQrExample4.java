...
public class AndroidBarcodeQrExample4 extends Activity implements JsonResponse
{
	...
	public void scanBar(View v) {
		try {
			...
			showDialog(AndroidBarcodeQrExample4.this, "No Scanner Found", "Download a scanner code activity?", "Yes", "No").show();
		}
	}
	...
	public void onActivityResult(int requestCode, int resultCode, Intent intent) {
		if (requestCode == 0) {
			if (resultCode == RESULT_OK) {
				...
				JR.json_response=(JsonResponse) AndroidBarcodeQrExample4.this;
				String q="/getstaffdetails2?contents="+contents+ "&logid=" + sh.getString("log_id", "");
				q=q.replace(" ","%20");
				JR.execute(q);
...
//					startActivity(new Intent(getApplicationContext(), Userhome.class));
				...
				String q="/AndroidBarcodeQrExample4?contents="+contents+"&latitude="+tolatti +"&longitude="+tolongi+ "&logid=" + sh.getString("log_id", "")+"&rid="+Userfirstrequestview.rid +"&amts="+Userfirstrequestview.amts;
				q=q.replace(" ","%20");
				JR.execute(q);
